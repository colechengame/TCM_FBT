...
const MemberInfoCard = ({ fiveTypeData, historicalFiveTypeData }) => {
...
const DataAnalysisCard = ({ weightRecords, dateRange, onDateRangeChange }) => {
  const colors = theme.light;
  
  // Progress indicator component for showing changes
  const ProgressIndicator = ({ label, value, targetValue, color, unit = '', reverse = false }) => {
  ...
  const DateFilterButton = ({ days, label, currentStartDate, onClick }) => {
    const [isHovered, setIsHovered] = useState(false);
                      ...
                      <div style={{
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                          <div style={{ 
                            ...
                            <div style={{ fontSize: '1.1rem', fontWeight: 'bold', color: colors.dark }}>
                                      ...
                                      tooltip: {
                                        ...
                                        callbacks: {
                                          label: function(context) {
                                            ...
                                            if (index > 0) {
                                              const diff = +(context.parsed.y - context.dataset.data[index - 1]).toFixed(1);
                                              label += `\n變化: ${diff > 0 ? '+' : ''}${diff} kg`;
                                            }
                      ...
                      <div style={{
                        ...
                        <div style={{ marginBottom: '10px' }}>
                          <div style={{ 
                            ...
                            <div style={{ fontSize: '0.9rem', fontWeight: 'bold', color: colors.primary, marginBottom: '4px' }}>
                          ...
                          <div style={{ 
                            ...
                            <div style={{ fontSize: '0.9rem', fontWeight: 'bold', color: colors.warning, marginBottom: '4px' }}>
                              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '6px' }}>
                        ...
                        {(() => {
                          ...
                          return (
                            <div style={{ 
                              ...
                              <div style={{ fontSize: '0.9rem', fontWeight: 'bold', color: colors.info, marginBottom: '4px' }}>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '6px' }}>
                                  <circle cx="12" cy="12" r="10"></circle>
